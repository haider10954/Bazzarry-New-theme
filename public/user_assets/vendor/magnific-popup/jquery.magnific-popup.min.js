!function (e) {
    ...
    var t, i, n, o, a, r, s = "Close", l = "BeforeClose", c = "MarkupParse", d = "Open", p = "Change", u = "mfp",
        f = ".mfp", m = "mfp-ready", g = "mfp-removing", v = "mfp-prevent-close", h = function () {
        }, C = !!window.jQuery, y = e(window), w = function (e, i) {
            t.ev.on(u + e + f, i)
        }, b = function (t, i, n, o) {
    ...
    h.prototype = {
        ...
        if ("string" == typeof i) if ("open" === i) {
            var o, a = C ? n.data("magnificPopup") : n[0].magnificPopup, r = parseInt(arguments[1], 10) || 0;
            a.items ? o = a.items[r] : (o = n, a.delegate && (o = o.find(a.delegate)), o = o.eq(r)), t._openClick({mfpEl: o}, n, a)
        } else t.isOpen && t[i].apply(t, Array.prototype.slice.call(arguments, 1)); else i = e.extend(!0, {}, i), C ? n.data("magnificPopup", i) : n[0].magnificPopup = i, t.addGroup(n, i);
        return n
    };
    ...
    e.magnificPopup.registerModule(O, {
        options: {
            ...
            initAjax: function () {
                ...
                var n = e.extend({
                    url: i.src, success: function (n, o, a) {
                        var r = {data: n, xhr: a};
        ...
        options: {
            ...
            initZoom: function () {
                ...
                if (i.enabled && t.supportsTransition) {
                    var o, a, r = i.duration, s = function (e) {
                ...
                var s = {width: n.width(), height: (C ? n.innerHeight() : n[0].offsetHeight) - r - a};
