...
<head>
    ...
    <meta name="keywords" content="Marketplace ecommerce, online store"/>
    <meta name="description" content="Bazaarry is powerful marketplace &amp; ecommerce store.">
...
<div class="page-wrapper">
    <h1 class="d-none">Bazaarry - Responsive Marketplace e-commerce store</h1>
    <!-- Start of Header -->
...
<div class="sticky-footer sticky-content fix-bottom">
    <a href="javascript:void(0)" class="sticky-link active">
                        ...
                        <ul>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="shop-off-canvas.html">Off Canvas Sidebar<span class="tip tip-new">New</span></a>
                                    </li>
...
<div class="newsletter-popup mfp-hide">
    <div class="newsletter-content">
        ...
        <form action="#" method="get" class="input-wrapper input-wrapper-inline input-wrapper-round">
            <input type="email" class="form-control email font-size-md" name="email" id="email2" placeholder="Your email address"
                   required="">
    ...
    <div class="modal-content">
        ...
        <div class="login-popup p-2">
            <div class="tab tab-nav-boxed tab-nav-center tab-nav-underline">
                ...
                <div class="tab-content w-100 ps-0">
