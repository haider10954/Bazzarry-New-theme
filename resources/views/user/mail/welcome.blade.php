                    ...
                    <tbody><tr>
                        <td align="center" class="" valign="top"><table cellpadding="0" cellspacing="0" style="margin: 0 auto;" width="100%">
                            ...
                            <table bgcolor="#fff" cellpadding="0" cellspacing="0" class="" style="margin: 0 auto; width: 100%; margin-top: 100px;">
                                ...
                                <tr class="">
                                    <td class="">
                                        <img alt="robot picture" class="" height="155" src="https://proptech-kenya.firebaseapp.com/assets/images/logo.png" width="155">
                                    </td>
                                </tr>
                                <tr class=""><td class="headline">Welcome to PropTech!</td></tr>
                                <tr>
                                    <td>
