@extends('seller.layout.layout',['useAssets'=>['swiper','product_details']])
@section('title','Product Details | Bazaarry')
@section('content')
                                        ...
                                        <div class="swiper product-thumbnail-slider p-2 rounded bg-light">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <img src="{{asset('seller_assets/images/products/img-8.png')}}" alt="" class="img-fluid d-block" />
                                                </div>
                                                <div class="swiper-slide">
                                                    <img src="{{asset('seller_assets/images/products/img-6.png')}}" alt="" class="img-fluid d-block" />
                                                </div>
                                                <div class="swiper-slide">
                                                    <img src="{{asset('seller_assets/images/products/img-1.png')}}" alt="" class="img-fluid d-block" />
                                                </div>
                                                <div class="swiper-slide">
                                                    <img src="{{asset('seller_assets/images/products/img-8.png')}}" alt="" class="img-fluid d-block" />
                                                </div>
                                                                    ...
                                                                    <div class="border border-dashed rounded p-3">
                                                                        ...
                                                                        <div class="d-flex flex-grow-1 gap-2 mb-3">
                                                                            <a href="#" class="d-block">
                                                                                <img src="{{asset('seller_assets/images/small/img-12.jpg')}}" alt="" class="avatar-sm rounded object-cover">
                                                                            </a>
                                                                            <a href="#" class="d-block">
                                                                                <img src="{{asset('seller_assets/images/small/img-11.jpg')}}" alt="" class="avatar-sm rounded object-cover">
                                                                            </a>
                                                                            <a href="#" class="d-block">
                                                                                <img src="{{asset('seller_assets/images/small/img-10.jpg')}}" alt="" class="avatar-sm rounded object-cover">
                                                                            </a>
                                                                        </div>
