...
@section('content')
                                    ...
                                    <div class="tab-pane active" id="addproduct-general-info" role="tabpanel">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="manufacturer-name-input">Manufacturer
                                                        Name</label>
                                                    <input type="text" class="form-control" name="manufacturer_name" id="manufacturer-name-input"
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               id="product-discount-input" name="discount" placeholder="Enter discount"
                                                               aria-label="discount"
                                            ...
                                            <div class="col-lg-3 col-sm-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                           for="product-discount-input">SKU <span class="text-danger">*</span></label>
                                                    <div class="input-group mb-3">
                                                        <input type="text" class="form-control w-100"
                                                               id="product-discount-input" placeholder="Enter Sku"
                                                               aria-label="sku"
                                                               name="sku"
                                    ...
                                    <div class="select-box">
                                        <div class="select-box__current" tabindex="1">
                                            <div class="select-box__value">
                                                <input class="select-box__input" type="radio" id="public" value="1"
                                                       name="visibility" checked="checked">
                                                <p class="select-box__input-text">Public</p>
                                            </div>
                                            <div class="select-box__value">
                                                <input class="select-box__input" type="radio" id="hidden" value="0"
                                                       name="visibility">
                                                <p class="select-box__input-text">Hidden</p>
                                            </div>
                                            <img class="select-box__icon"
                                                 src="{{asset('admin_assets/images/local-Assets/down-arrow.png')}}"
                                                 alt="Arrow Icon" aria-hidden="true">
                                        </div>
                                        <ul class="select-box__list">
                                            <li>
                                                <label class="select-box__option" for="public"
                                                       aria-hidden="aria-hidden">Public</label>
                                            </li>
                                            <li>
                                                <label class="select-box__option" for="hidden"
                                                       aria-hidden="aria-hidden">Hidden</label>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="add-category" tabindex="-1" aria-labelledby="exampleModalgridLabel"
         aria-modal="true">
    ...
    <script>
        ...
        function addVariant()
        {
            ...
            $("."+value+" input:checked").each(function (){
                optionList.push({id:$(this).val(),name:$(this).attr("data-name")});
            });
